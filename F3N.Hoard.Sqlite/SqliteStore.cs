...
{
    public class BlobCacheStorage : IStorage
    {
        private readonly IBlobCache _db;
        public BlobCacheStorage() 
        {
            _db = SqliteConfig.Database;
        }
        internal BlobCacheStorage(IBlobCache db)
        {
            _db = db;
        }
